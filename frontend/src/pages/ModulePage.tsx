    ...
    useEffect(() => {
        const fetchVideoUrl = async () => {
            ...
            try {
                ...
                const res = await client.get(`https://disaster-preparedness-app.onrender.com/api/education/video-url/${lesson.content}`, {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const [moduleRes, progressRes] = await Promise.all([
                    client.get(`https://disaster-preparedness-app.onrender.com/api/education/modules/${moduleId}`, { headers: { Authorization: `Bearer ${token}` } }),
